...
export default class API {
	...
	public static readonly sendMessage: (data: any) => Promise<any> = async (
		data: any
	): Promise<any> => { };
	public static readonly getNotifications: (data: any) => Promise<any> =
		async (data: any): Promise<any> => { };
	public static readonly getUserMessage: (data: any) => Promise<any> =
		async (data: any): Promise<any> => { };
	public static readonly addFriend: (data: any) => Promise<any> =
		async (data: any): Promise<any> => { };
}