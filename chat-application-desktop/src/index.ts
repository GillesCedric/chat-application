...
const secureStore = new SecureStore(
  "chat-application-desktop-encryption-generation-key"
);
...
const getSystemFingerprint = async () => {
  try {
    const [systemInfo, cpuInfo, osInfo, biosInfo, baseboardInfo, chassisInfo] =
      await Promise.all([
        si.getStaticData(),
        si.cpu(),
        si.osInfo(),
    ...
    console.error(
      "Erreur lors de la récupération de l'empreinte du système :",
      error
    );
    return null;
  }
