      ...
      <div className="flex flex-col h-full">
        ...
        <div className="flex flex-1 bg-white">
          ...
          <div className="w-2/12 border-r border-gray-300 flex flex-col bg-blue-50">
            {conversations.map((value, index) => (
              <Conversation key={index} name={value} />
            ))}
          </div>
        ...
        <div className="flex justify-center items-center h-1/6 border-t border-gray-300 bg-blue-100">
          <div className="w-2/12">
            <button className="bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-red-600 focus:outline-none focus:ring focus:border-blue-700 transition duration-300">
              Ajouter un contact
            </button>
          </div>
          <div className="w-10/12">
            <textarea
              className="w-full h-full p-4 text-gray-400 bg-gray-200"
