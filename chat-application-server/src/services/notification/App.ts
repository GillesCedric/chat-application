        ...
        try {
            if (process.env.NODE_ENV == "development")
                ...
                this._httpsServer = createHTTPSServer({
                    ...
                    key: fs.readFileSync(path.join(process.cwd(), 'certs', Services.notification, `${Services.notification}-key.pem`)),
                    cert: fs.readFileSync(path.join(process.cwd(), 'certs', Services.notification, `${Services.notification}-cert.pem`)),
