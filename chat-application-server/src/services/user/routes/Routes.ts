...
export default class Routes {
  ...
  public static readonly routes = (app: Application): void => {
    ...
    app
      ...
      .get(
        ...UserValidators.getUserFriendRequests,
        UserValidators.errors,
        this.userController.getUserFriendRequests
      );
    app
      ...
      .put(
        ...
        UserValidators.errors,
        this.userController.updateUserFriendRequest
      );
    app
      .route("/checkUnique")
      .post(
        ...UserValidators.checkUnique,
        UserValidators.errors,
        this.userController.checkIfExists
      );
    app
      .route("/activate/email")
      .get(
        ...UserValidators.activateEmail,
        UserValidators.errors,
        this.userController.activateEmail
      );
    app
      .route("/activate/tel")
      .post(
        ...UserValidators.activateTel,
        UserValidators.errors,
        this.userController.activateTel
      );
    app
      .route("/verify/tel")
      .post(
        ...UserValidators.verifyTel,
        UserValidators.errors,
        this.userController.verifyTel
      );
    app
      .route("/connect")
      .post(
        ...UserValidators.connect,
        UserValidators.errors,
